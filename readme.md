# Programming Test: Theater Seating

## Runing Application
This application can be run as a console java application. To change the input, please modify the input.txt in the project root to gain insight into different outputs. 
